...
router.get('/goals', userCheck, async (req, res) => {
    try {
...
// Create a new goal
router.post('/goals', userCheck, async (req, res) => {
    try {
...
router.put('/goals/:id', userCheck, async (req, res) => {
    try {
...
// Delete a goal
router.delete('/goals/:id', userCheck, async (req, res) => {
    try {
        const goalId = req.params.id;
